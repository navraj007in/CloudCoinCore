...
namespace Founders
{
    class Program
    {
        ...
        public static String[] commandsAvailable = new String[] { "Echo raida", "Show CloudCoins in Bank", "Pown & Deposit New", "Withdraw CloudCoins", "Fix Fracked", "Show Folders", "Export stack files with one note each", "Help", "Quit", "Detect", "Test DA", "Test timers", "Test Grader" };
        ...
        public static void run()
        {
            ...
            while (!restart)
            {
                ...
                Console.ForegroundColor = ConsoleColor.White;
                int commandRecieved = reader.readInt(1, commandCounter);
                switch (commandRecieved)
                {
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        Console.WriteLine("What RAIDA (0-24) do you wish to check? ");
                        int RAIDA = reader.readInt(0, 28);
                        testDAAsync(RAIDA, 2000);
                        break;
                    case 12:
                        Console.WriteLine("What RAIDA (0-24) do you wish to check? ");
                        int RAIDA2 = reader.readInt(0, 28);
                        Console.WriteLine("How many milliseconds do you want the timeout to be? ");
                        int timeout = reader.readInt(0, 110000);
                        testDAAsync(RAIDA2, timeout);
                        break;
                    case 13:
                        Console.WriteLine("Testing Grader");
                        Grader myGrader = new Grader(fileUtils);
                        int[] results = myGrader.gradeAll(5000, 2000);
                        Console.Out.WriteLine("       Bank :" + results[0]);
                        Console.Out.WriteLine("    Fracked :" + results[1]);
                        Console.Out.WriteLine("Counterfeit :" + results[2]);
                        Console.Out.WriteLine("    Suspect :" + results[3]);
